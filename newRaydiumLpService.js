...
function parseCreateAmmLpParams(data) {
    return {
        ...
        initPcAmount: data.readBigUInt64LE(10).toString(), // Keep as lamports
        initCoinAmount: data.readBigUInt64LE(18).toString(), // Keep as lamports
    };
}
        ...
        for (const ix of instructions) {
            ...
            if (programId === RAYDIUM_AMM_PROGRAM_ID.toString() && ix.data.length > 0) {
                ...
                let tokenData = {
                    ...
                    wrappedSOLAmount: indexedAccounts.tokenAddress === WSOL_MINT
                        ? params.initCoinAmount // Already in lamports
                        : null
                };
